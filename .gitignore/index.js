...
var channelStockId = "751874795544772738";  //Max, met ici l'id du channel !

var dataBank = []; //Contient des tableaux : C'est la base de données quand le bot est actif !

var channelStockIdPersos = "751874758555074590";

var dataBankPersos = [];

var channelStockIdFight = "751874827815616624";
...
bot.on('message', message => { //memo
    if(message.content === "!!memo" && message.member.roles.has("751731928557682718")){
...
bot.on('message', message => {
    if(message.content === "!!read" && message.member.roles.has("751731928557682718")){
        dataBank = []
        dataBankPersos = []
        dataBankFight = []
        read()
...
bot.on('message', message => {
    if(message.content === "!!sommeil" && message.member.roles.has("751731928557682718")){
...
bot.on('message', message => {
    if(message.content === "!!para" && message.member.roles.has("751731928557682718")){
...
bot.on('message', message => {
    if(message.content === "!!statik" && message.member.roles.has("751731928557682718")){
...
bot.on('message', message => {
    if(message.content.includes("!!poison " && message.member.roles.has("751731928557682718"))){
...
bot.on('message', message => { //Joli Sourire
    if(message.content === "!!Joli Sourire" && message.member.roles.has("751731928557682718")){
...
bot.on('message', message => { //Prio
  if(message.content.includes("!!prio") && message.member.roles.has("751731928557682718")){
...
bot.on('message', message => { //points de vies
    if(message.content.includes("!!pv" && message.member.roles.has("751731928557682718"))){
...
bot.on('message', message => { // !!logz
  if(message.content.includes("!!logz " && message.member.roles.has("751731928557682718"))){
...
bot.on('message', message => { // !!dégats
  if(message.content.includes("L'attaque fait ") && message.author.id === "497512073035776000"){
...
bot.on('message', message => { // !!dégats vit
  if(message.content.includes(" lui fait assainer une nouvelle attaque") && message.author.id === "497512073035776000"){
    setTimeout(() => {
    var daigz = message.content.split("**")[1]
    var nomz = message.content.split("**")[3]
    console.log(daigz + " à " + nomz)
...
bot.on('message', message => { // !!dégats poison
  if(message.content.includes("à cause du poison") && message.author.id === "497512073035776000"){
    setTimeout(() => {
    var daigz = message.content.split("**")[1]
    var nomz = message.content.split("**")[3]
    console.log(daigz + " à " + nomz)
...
bot.on('message', message => { // !!heal
  if(message.content.includes("!!heal " && message.member.roles.has("751731928557682718"))){
